...
R is the coding language and Rstudio is the GUI, allowing us to write the codes more easily. Github is a online platform that allows people to store and manage their code online. It is useful to programmers as it allows you to access the code anywhere and collaborate with others. 
...
The results in #4 didn't really surprise me as the results follow the order of operations or PEMDAS. 
