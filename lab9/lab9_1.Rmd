...
*The column names are observations. We need every variable be its column to make a plot.*
...
```{r}
#These data are not tidy because the columns (days) are observations
```
