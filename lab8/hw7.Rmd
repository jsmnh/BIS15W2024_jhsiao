...
*It makes sense that percent missing for mammals is zero because mammals don't lay eggs. For birds, 50% missing could make sense. However, repitles with 92% missing doesn't really make sense as they lay eggs too.*
```{r}
amniota_no_nas %>% 
  group_by(class) %>% 
