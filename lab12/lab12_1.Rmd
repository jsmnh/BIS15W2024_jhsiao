...
#install.packages("RColorBrewer") # Do NOT knit and install packages, it won't work
...
homerange %>% 
  ...
  geom_histogram(fill = "steelblue", alpha = 0.4, color = "gray43")+
...
homerange %>% 
  ggplot(aes(x=log10.hra)) + # Only need to specify x
  geom_density(fill = "steelblue", alpha = 0.4, color = "gray43")+
  labs(title = "Distribution of Homerange")
```
...
homerange %>% 
  ...
  geom_histogram(aes(y=after_stat(density)), fill = "steelblue", alpha = 0.3, color = "gray43")+
