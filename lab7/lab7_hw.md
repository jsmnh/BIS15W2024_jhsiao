...
We need to deal with the years because they are being treated as characters and start with an X. We also have the problem that the column names that are years actually represent data. We haven't discussed tidy data yet, so here is some help. You should run this ugly chunk to transform the data for the rest of the homework. It will only work if you have used janitor to rename the variables in question 2!  (remove hashtags before working)
...
Peru had the largest catch in 2000. 
...
## # A tibble: 199 × 3
## # Groups:   country [199]
##    country                   year max_catch
##    <fct>                    <dbl>     <dbl>
##  1 Peru                      2000     77000
##  2 Japan                     2000      9954
##  3 Chile                     2000      9941
##  4 United States of America  2000      9928
##  5 China                     2000      9899
##  6 Viet Nam                  2000      9806
##  7 Russian Federation        2000      9758
##  8 South Africa              2000      9700
##  9 Myanmar                   2000      9640
## 10 Iceland                   2000      9191
## # ℹ 189 more rows
```

7. Which country caught the most sardines (_Sardina pilchardus_) between the years 1990-2000?
Morocco has caught the most sardines between the years. 
...
India, China, Algeria, France, and TimorLeste caught the most cephalopods between the years.
...
Theragra chalcogramma has the highest catch between the years. 
...
Indonesia has the most mackerel catches between 1995 and 2005. 

```r
fisheries_tidy %>% 
  filter(year >= 1995 & year <= 2005, asfis_species_name == "Scomberomorus commerson") %>% 
  group_by(country) %>% 
  summarize(total_catch = sum(catch)) %>% 
  arrange(desc(total_catch))
```
